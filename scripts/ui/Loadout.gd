...
const MARKET_PAGES: Array = [
	"시장: 잘 왔네. 떠날 채비를 도와주지.",
	"시장: 가방은 여섯 칸뿐일세.\n물과 식량이 곧 목숨이고, 로프는 갈라진 틈을,\n은신막은 폭풍을 견디게 하네.",
	"시장: 다만 짐이 무거우면 그만큼 목이 타네.\n가방을 가득 채울수록 걸음마다 물이 더 들지.\n욕심은 금물일세.",
	"시장: 지도에서 갈 곳을 고르면\n원정대가 그리로 가네.\n걸음마다 물이 닳으니, 멀수록 목이 마르지.",
	"시장: 도착한 곳은 몇 번 살필 수 있네.\n살피는 데 자원은 안 드니 아끼지 말게.",
	"시장: 죽기 전 단 한 번, 물건을 남길 수 있네.\n다음 원정대가 그걸 줍지.\n무엇을 남길지가 자네 몫일세.",
	"시장: 이 기록지를 가져가게.\n떠난 원정대의 이야기가 여기 적힐 걸세.\n화면 구석 책갈피에서 언제든 펴 보게.",
]
...
const REUNION_HINT_PAGES: Array = [
	"시장: 끝에 닿았다 왔다지.\n그런데도 릴레이는 이어지는군.",
	"시장: 옛말이 하나 있네.\n잘 물려주고, 길에 잠든 이들을 기린 원정대만이,\n밀어내지 않고 지나간다고.",
	"시장: 물건을 남기게.\n그리고 죽은 자리를 그냥 지나치지 말게.\n그게 전부일지도 모르지.",
]
