...
## ⚠ 어미·수사 구조도 겹치지 않게(2026-07-13 사용자 3차 지적): "~단다" 4회, 어록의
## "X는 ~는 게 아니라 Y" 3회처럼 한 계열 안에서 같은 꼴이 반복되면 규칙서처럼 읽힌다.
## 저작 후 어미·구조만 모아 읽어 겹침을 확인할 것(같은 꼴은 한 번만).
...
const LIST: Array = [
	{
		...
		"done": "들판 너머까지 간 원정이 그를 불렀다.",
		"stat": "max_row_visited", "at_least": 4,
	},
	{
		"id": "heavy_back", "unlocks": "porter",
		"name": "짐을 진 이",
		"cond": "무겁게 짐을 진 행렬 얘기만 나오면\n어깨부터 푸는 젊은이가 있다.",
		"line": "짐꾼이 마을에 왔다.\n\"질 수 있는 만큼이 아니라,\n져야 하는 만큼 지는 거요.\"",
		"done": "무겁게 진 출발을 보고 짐을 자청했다.",
	...
	},
	{
		...
		"name": "주림을 견딘 이",
		"cond": "굶는 법을 아는 사내가 하나,\n주림에 쓰러졌다는 말이 거듭돼서야\n몸을 일으킨다.",
		"line": "강골이 마을에 왔다.\n\"주림은 늦출 수 있는 놈이다.\n그거면 하루를 더 걷지.\"",
		"done": "주림에 쓰러진 소식이 그의 등을 밀었다.",
		"stat": "hunger_deaths", "at_least": 2,
	},
	{
		"id": "left_three", "unlocks": "keeper",
		"name": "세 번 남긴 이",
		"cond": "죽은 이들의 짐을 지켜 온 사람.\n세 번을 남긴 원정대라야\n제 일을 맡길 만하다 여긴다.",
		"line": "유품지기가 마을에 왔다.\n\"두고 가는 법을 아는 사람은 드물지.\"",
		"done": "세 번 남긴 원정대에게 제 일을 맡기러 왔다.",
