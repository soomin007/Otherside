...
**01~46 + 38 전부 삽입·배선 완료(2026-07-04).** 남은 것은 **오프닝 가로판(24~28가로)뿐** — 배선돼 있어 뽑아 넣으면 자동 반영(없으면 세로본 fallback). 그 외는 폰/웹 시각 확인·톤 조정(스크림 알파 Opening 0.5·Main 0.35, cover/contain).
