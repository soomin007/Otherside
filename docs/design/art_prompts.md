...
**01~46 전부 삽입·배선 완료(2026-07-04).** 남은 것은 **선택 항목뿐** — 열린 가방(38)·오프닝 가로판(24~28가로). 둘 다 배선돼 있어 뽑아 넣으면 자동 반영(없으면 fallback). 그 외는 폰/웹 시각 확인·톤 조정(스크림 알파 Opening 0.5·Main 0.35, cover/contain).
