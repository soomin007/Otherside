...
> 마지막 대규모 갱신: 2026-07-12 (재회 세 축: 기림 2·구조 2·온전 / 위기 순간(위기 클러스터, DESO 32·CLOSE 1) /
> 대가 문법·후속 장면 then 체인(스토리 먼저·가짜 선택 금지) / 지도 뷰 카메라(가본 만큼 확대)·두루마리 툴팁 /
> 일지 키워드 색·괘선 폐지·터치 확대 / 터치 이중입력 함정(known_issues) / 직능 해금(공훈) / 공략·매뉴얼 재발행).
