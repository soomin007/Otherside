...
> 마지막 대규모 갱신: 2026-07-13 (낙오자 사연 카드(출처=원정 이름·사연, 거두기 then)·손실 전용 문구 /
> 기록형 공훈 4종(달성 전 비노출)·해금 연출 모달(새 얼굴 인물 등장)·해금 내력 done / 행렬 실루엣 줄 +
> 스러짐 원화(손실·구조 팝업) / 일지 마을 챕터 펼침 넘김(책 원칙: 스크롤 금지)·항목 구분 / 남기기 새길 말
> 화면 재구성(붓글씨 미리보기·단어 가운데 한 줄) / then 체인 3곳(b2·e1·오아시스) / 이름 풀 확장·패턴 정리 /
> 쓰러지다·스러지다 용례 규칙(CLAUDE.md)).
> (직전 대규모: 2026-07-12 — 재회 세 축 / 위기 순간 / 대가 문법·then / 지도 뷰 카메라 / 공략·매뉴얼 재발행.)
